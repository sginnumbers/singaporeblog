...
The average number of children per woman is also known as the **total fertility rate (TFR)**. The TFR needed for a population to replace itself is 2.1.^[ Assuming no net migration and unchanged mortality.] This means that, on average, each woman must give birth to 2.1 children.^[There is no such thing as 0.1 child. The number, 2.1, represents the _average_ number of children each woman in the entire population needs to give birth to. It may be more intuitive to think of it as at least 2 children.] This number, 2.1, is known as the **replacement-level fertility**. Anything below 2.1 is known as 'below-replacement fertility', and anything below 1.3 is known as 'very low fertility'.
...
+ The TFR for women who were 20--24 years old declined drastically. 
    + Up until the early 1980s, the TFR was very similar to the TFR of women who were 30--34 years old. 
