...
The chart below shows how Singapore (SGP) compares with `r length(unique(oecd$country))` OECD member and key partner countries^[list of countries and OECD data: https://data.oecd.org/healtheqt/hospital-beds.htm, accessed 27 March 2019]. To make the chart easier to read, only a few countries are labelled and emphasised^[JPN: Japan, KOR: Korea, CHN: China, USA: United States of America, GBR: Great Britain, SGP: Singapore, IND: India].
